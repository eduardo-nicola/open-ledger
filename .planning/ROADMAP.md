...
- [ ] 01-05-PLAN.md — Playwright config (3 projetos) + seed SQL + stubs de teste por @auth-XX (Wave 4)
- [ ] 01-06-PLAN.md — Implementação e execução dos testes E2E + checkpoint de verificação Google OAuth (Wave 5)
**UI hint**: yes
